...
import { Link, Edit, Delete, CopyDocument } from '@element-plus/icons-vue'
...
function onDragStart(e: DragEvent) {
  if (e.dataTransfer) {
    ...
    e.dataTransfer.setData('application/x-lite-ssh-conn', props.connection.id)
  }
}
</script>

<template>
  <div class="connection-row" draggable="true" @dblclick="onDoubleClick" @dragstart="onDragStart">
    <div class="row-main">
    ...
    <div class="row-actions">
      ...
      <el-tooltip content="复制" placement="bottom">
        <button class="action-btn" @click.stop="emit('copy', connection)">
...
.connection-row[draggable="true"] {
  cursor: grab;
}

.connection-row[draggable="true"]:active {
  cursor: grabbing;
}
